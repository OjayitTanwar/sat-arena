...
async function getConfig() {
  ...
  return {
    ...
    geminiModel: c.gemini_model || process.env.GEMINI_MODEL || 'gemini-2.5-flash',
    ...
    smtpHost: c.smtp_host || process.env.SMTP_HOST || '',
    smtpPort: parseInt(c.smtp_port || process.env.SMTP_PORT || '587', 10) || 587,
    smtpUser: c.smtp_user || process.env.SMTP_USER || '',
    smtpPass: c.smtp_pass || process.env.SMTP_PASS || '',
    smtpSecure: c.smtp_secure === '1' || String(process.env.SMTP_SECURE) === '1',
    ...
    premiumAnnualCents: parseInt(c.premium_annual_cents || process.env.PREMIUM_ANNUAL_CENTS || '7999', 10) || 7999,
    premiumLifetimeCents: parseInt(c.premium_lifetime_cents || process.env.PREMIUM_LIFETIME_CENTS || '14900', 10) || 14900,
  };
}
